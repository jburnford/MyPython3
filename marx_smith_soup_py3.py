...
#    (learned from http://stackoverflow.com/questions/18280436/importerror-matplotlib-requires-dateutil)
# 2. Apart from that, the conversion to python3 could be done automatically.
#    The changes are:
#    urllib2 --> urllib.request, urllib.error, urllib.parse
#        (note, that urllib.error and urllib.parse are not used, thus, these
#        imports can be removed.
#    print statement --> print function
#    raw_input --> input
#        (input in Python3 behaves like raw_input in Python2).
